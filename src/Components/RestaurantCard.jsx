...
function RestaurantCard({cloudinaryImageId,cuisines,id,avgRating,name,locality,areaName,sla,aggregatedDiscountInfoV3}) {
 ...
 className='flex flex-col m-4 min-w-[280px] max-w-[280px] cursor-pointer shadow-lg object-cover overflow-hidden bg-white hover:border-2  border-amber-300 rounded-2xl '>
        <div className='relative'>
          ...
          <span className='absolute font-bold bottom-0 w-full py-2 pt-20 text-2xl px-2 bg-gradient-to-b from-[rgba(27,30,36,0)] to-[rgb(27,30,36)] to-[84.21%] text-white'>{aggregatedDiscountInfoV3?.header+""+aggregatedDiscountInfoV3?.subHeader}</span>
        </div>
